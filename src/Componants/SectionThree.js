...
export default function SectoinThree() {
 const {trendBook}=useContext(DataContext);
 console.log(trendBook)
  return (
    <>
      <Box Container id="trending-section" sx={{width:"100%",padding:'30px',boxSizing:'border-box' ,boxShadow:"0px 40px 40px 0px rgb(0,0,0,0.3)",padding:"50px",width:"100%", borderRadius:'6px'}} >
        ...
        <Grid container justifyContent="center" sx={{ maxWidth: "1200px", margin: "0 auto",marginTop:'20px'}}>
            ...
            {
                trendBook.map((e,inc)=>{
              return <Grid  key={inc} size={{xs:4,md:4,sm:12}} >
               <Box sx={{width:"100%"}} >
